...
public class Library {
    ...
    public Library(String addres){
        Library.this.addres = addres;
    }

    // Сюда надо добавить недостающие методы
    public static void addBook(Book title){
        List<Book> name = new ArrayList<>();
        name.add(title);
        System.out.println(title.getTitle());
    }

    public static void printAddress(Library name){
    ...
    public static void main(String[] args) {
        ...
        firstLibrary.printAddress(firstLibrary); // Выводит адрес
